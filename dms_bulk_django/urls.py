...
from dms_bulk_django.sitemap import DMSBulkStaticSitemap
from dms_bulk_django.sitemap import ArticlesSitemap


sitemaps = {
    'static': DMSBulkStaticSitemap,
    'blog': ArticlesSitemap,
}
