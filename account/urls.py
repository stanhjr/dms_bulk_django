...
urlpatterns = [
    ...
    path('settings-password/', views.PasswordChangeNoCodeView.as_view(), name='change_password'),
    path('settings-password-change-code/', views.PasswordChangeByCodeView.as_view(success_url=reverse_lazy('home')), name='change_password_code'),
