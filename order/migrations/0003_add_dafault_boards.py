...
def create_default_board(apps, schema_editor):
    board = BoardModel.objects.create(
        ...
        twitter_board_amount=['10k', '50k', '75к', '100k', '150к', '200k', '250к', '300k', '500k', '600к', '700k',
                              '1m'],
        twitter_board_discount=['0%', '12%', '12%', '20%', '20%',
                                '28%', '28%', '28%', '32%', '32%', '32%', '40%'],
        ...
        discord_board_amount=['10k', '50k', '75к', '100k', '150к', '200k', '250к', '300k', '500k', '600к', '700k',
                              '1m'],
        discord_board_discount=['0%', '12%', '12%', '20%', '20%',
                                '28%', '28%', '28%', '32%', '32%', '32%', '40%'],
        ...
        telegram_board_amount=['10k', '20к', '30k', '40k',
                               '50k', '60к', '70k', '100k', '120к', '150k', '300k'],
        telegram_board_discount=['0%', '3%', '3%', '5%',
                                 '8%', '8%', '8%', '10%', '10%', '10%', '13%'],
...
class Migration(migrations.Migration):
    dependencies = [
        ('order', '0002_ordermodel_send_messages_speed_and_more'),
    ]
    operations = [
